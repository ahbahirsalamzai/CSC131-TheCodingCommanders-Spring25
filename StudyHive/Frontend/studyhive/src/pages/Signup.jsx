...
/*Keeps track of field validation errors*/
...
/*Event Handelers: handleInputChange,handleRoleChange,handleSubmit*/

    /*Update user input data (formdatd)*/
const handleInputChange = (e) => {
   ...
   /*Switches between "tutor" and "Student" */
const handleRoleChange = (role) => {
    setFormData((prev) => ({ ...prev, role }));
};


/*Validates everthing to send to server*/
    ...
    <div className="w-full max-w-[1440px] mb-[150px] flex justify-center items-center">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6 w-full items-center mt-6">
            ...
            <div className="flex gap-4 mt-2">
                <div
                className="flex items-center gap-2 p-2 rounded-lg cursor-pointer hover:bg-gray-100 transistion"
        ...
        Already have an account?
            ...
            <a href="/Login" className="text-[#1f4d39] text-base font-bold ml-2">
            Sign In
            </a>
        </div>
        </div>
        ...
        {/* Image Section */}
        <div className="hidden xl:block w-[600px] h-[800px] mb-[20px] mt-[150px] overflow-hidden rounded-[31px] ml-12">
        <img
